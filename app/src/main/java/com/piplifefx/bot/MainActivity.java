...
public class MainActivity extends Activity {
    ...
    Switch live;
    TextView status, log, githubVersion;
    ...
    @Override protected void onCreate(Bundle b) {
        ...
        githubVersion=findViewById(R.id.githubVersion);
    ...
    void readLog() {
        try {
            ...
            while((line=r.readLine())!=null && n++<120) {
                s.append(line).append("\n");

                if(line.contains("GITHUB VERSION |")) {
                    int p=line.indexOf("GITHUB VERSION |");
                    version=line.substring(p + "GITHUB VERSION |".length()).trim();
                }
            }
            ...
            if(version != null && !version.isEmpty()) {
                githubVersion.setText("GitHub version: " + version);
            }
